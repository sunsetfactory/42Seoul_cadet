...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/12/20 00:09:30 by seokjyan          #+#    #+#             */
/*   Updated: 2023/12/20 00:09:30 by seokjyan         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	eating(t_philo *philo)
{
	...
	pthread_mutex_lock(&philo->table->time_eat_mtx);
	ft_usleep(philo->table->time_eat);
	pthread_mutex_unlock(&philo->table->time_eat_mtx);
}
